...
import {userLoginSelector} from '../../redux/selectors/userSelector'; // Điều chỉnh đường dẫn theo đúng cấu trúc của dự án
    ...
    <View style={styles.headerContainer}>
      <View style={styles.leftHeader}>
        <Image
          ...
          source={
            infoLogin.avatarUser
              ? {uri: infoLogin.avatarUser}
              : require('../../assets/images/logoApp/logo.png')
          }
        />
      </View>
      <View style={styles.centerHeader}>
        ...
        <View style={styles.centerFlow}>
          <Text style={styles.textFlow}>
            Người theo dõi {infoLogin.followers?.length}
          </Text>
          <Text style={styles.textFlow}> | </Text>
          <Text style={styles.textFlow}>
            Đang theo dõi {infoLogin.followings?.length}
          </Text>
        </View>
